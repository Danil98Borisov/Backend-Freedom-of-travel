...
public class TestDataLoaderImpl implements TestDataLoader {
    ...
    public List<User> getUserList() {
        ...
        userList.add(new User(3L, "User1", "user1@mail.ru", encoder.encode("user1pass")));
        userList.add(new User(4L, "User2", "user2@mail.ru", encoder.encode("user2pass")));
        return userList;
    }
    ...
    public List<UserRole> getUserRoleList() {
        ...
        userRoleList.add(new UserRole(3L, 3L, 1L));
        userRoleList.add(new UserRole(4L, 4L, 1L));
        return userRoleList;
    }
    ...
    public List<Reservation> getReservationList() {
        ...
        reservationList.add(new Reservation(1L, new Hotel(4L), new Apartment(1L), new User(1L), LocalDate.parse("2021-01-03", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-01-05", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(2L, new Hotel(4L), new Apartment(4L), new User(1L), LocalDate.parse("2021-03-06", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-03-20", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(3L, new Hotel(4L), new Apartment(1L), new User(1L), LocalDate.parse("2021-03-05", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-03-10", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(4L, new Hotel(1L), new Apartment(5L), new User(1L), LocalDate.parse("2021-04-08", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-04-19", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(5L, new Hotel(7L), new Apartment(2L), new User(1L), LocalDate.parse("2021-07-05", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-07-08", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(6L, new Hotel(8L), new Apartment(23L), new User(1L), LocalDate.parse("2021-01-10", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-01-13", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(7L, new Hotel(10L), new Apartment(25L), new User(1L), LocalDate.parse("2021-01-15", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-01-20", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(8L, new Hotel(12L), new Apartment(28L), new User(1L), LocalDate.parse("2021-01-21", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-01-23", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(9L, new Hotel(13L), new Apartment(55L), new User(1L), LocalDate.parse("2021-02-01", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-02-10", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(10L, new Hotel(14L), new Apartment(12L), new User(1L), LocalDate.parse("2021-02-11", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-02-13", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(11L, new Hotel(15L), new Apartment(18L), new User(1L), LocalDate.parse("2021-02-14", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-02-20", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(12L, new Hotel(16L), new Apartment(33L), new User(1L), LocalDate.parse("2021-02-23", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-02-26", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(13L, new Hotel(17L), new Apartment(54L), new User(1L), LocalDate.parse("2021-03-02", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-03-07", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(14L, new Hotel(18L), new Apartment(41L), new User(1L), LocalDate.parse("2021-03-08", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-03-12", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(15L, new Hotel(19L), new Apartment(28L), new User(1L), LocalDate.parse("2021-03-13", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-03-20", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(16L, new Hotel(20L), new Apartment(37L), new User(2L), LocalDate.parse("2021-04-10", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-04-20", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(17L, new Hotel(20L), new Apartment(37L), new User(2L), LocalDate.parse("2021-05-06", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-05-20", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(18L, new Hotel(15L), new Apartment(34L), new User(2L), LocalDate.parse("2021-06-10", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-06-18", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(19L, new Hotel(21L), new Apartment(42L), new User(2L), LocalDate.parse("2021-07-02", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-07-10", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(20L, new Hotel(22L), new Apartment(40L), new User(2L), LocalDate.parse("2021-07-05", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-07-23", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(21L, new Hotel(23L), new Apartment(43L), new User(2L), LocalDate.parse("2021-08-10", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-08-24", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(22L, new Hotel(24L), new Apartment(45L), new User(2L), LocalDate.parse("2021-09-10", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-09-20", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(23L, new Hotel(25L), new Apartment(47L), new User(2L), LocalDate.parse("2021-09-15", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-09-20", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(24L, new Hotel(26L), new Apartment(46L), new User(2L), LocalDate.parse("2021-09-08", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-09-13", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(25L, new Hotel(27L), new Apartment(48L), new User(2L), LocalDate.parse("2021-10-05", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-10-10", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(26L, new Hotel(28L), new Apartment(49L), new User(2L), LocalDate.parse("2021-11-03", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-11-08", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(27L, new Hotel(29L), new Apartment(50L), new User(2L), LocalDate.parse("2021-11-08", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-11-13", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(28L, new Hotel(30L), new Apartment(51L), new User(2L), LocalDate.parse("2021-12-01", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-12-05", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(29L, new Hotel(11L), new Apartment(31L), new User(2L), LocalDate.parse("2021-12-03", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-12-20", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
        reservationList.add(new Reservation(30L, new Hotel(10L), new Apartment(11L), new User(2L), LocalDate.parse("2021-12-20", DateTimeFormatter.ofPattern("yyyy-MM-dd")), LocalDate.parse("2021-12-25", DateTimeFormatter.ofPattern("yyyy-MM-dd")), ReservationStatus.BOOKED.name()));
